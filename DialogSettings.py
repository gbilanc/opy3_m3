...
class DialogSettings(QDialog):
    ...
    def __init__(self):
        ...
        self.ui.spinBoxOffsetLaser.setValue(settings.offset_laser)
        ...
        self.ui.doubleSpinBoxLaserX.setValue(float(settings.pos_laser[0]))
        self.ui.doubleSpinBoxLaserY.setValue(float(settings.pos_laser[1]))
    ...
    def save_settings(self):
        ...
        settings.offset_laser = self.ui.spinBoxOffsetLaser.value()
        ...
        settings.pos_laser[0] = self.ui.doubleSpinBoxLaserX.value()
        settings.pos_laser[1] = self.ui.doubleSpinBoxLaserY.value()
